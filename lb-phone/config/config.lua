...
Config.Item.Inventory = "gamemode" --[[
...
Config.FrameColor = "#ffa04c" -- This is the color of the phone frame. Default (#39334d) is SILVER.
...
Config.KeyBinds = {
    ...
    RollLeft = {
        ...
        Bind = "Z",
        Description = "Faire pivoter la caméra vers la gauche"
    },
    RollRight = {
        Command = "cameraRollRight",
        Bind = "C",
        Description = "Faire pivoter la caméra vers la droite"
    },
    FreezeCamera = {
        Command = "cameraFreeze",
        Bind = "X",
        Description = "Geler la caméra"
    },
    ...
    DeclineCall = {
        Command = "declineCall",
        Bind = "BACK",
        Description = "Refuser un appel entrant"
    },
    UnlockPhone = {
        Bind = "SPACE",
        Description = "Ouvrir votre téléphone",
